...
const OTPVerificationPage = (props) => {
  ...
  const decodedEmail = decodeURIComponent(email); // @ wapas aa jayega
  ...
  useEffect(() => {
    ...
    if (token) {
      router.replace("/"); // direct replace taake history me na jaye
    } else {
    ...
    if (type == "signin" || type == "signup") {
      try {
        ...
        let res = await axios.post(
          `${process.env.NEXT_PUBLIC_API_NODEJS}/api/auth/${type}/code`,
          {
