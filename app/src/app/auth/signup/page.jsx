...
const SignUpPage = () => {
  ...
  // ✅ sab useState sabse pehle declare karo
  ...
  if (checking) {
    return null; // jab tak check ho raha hai kuch bhi render na karo
  }
  ...
  async function handleSignup(e) {
    ...
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_API_NODEJS}/api/auth/signup`,
        {
          username: username,
          email: email,
          password: password,
      ...
      settype("info");
      router.push(`/auth/code/${email}/signup`);
    } catch (err) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        <h2 className={styles.title}>Create a Zyra Account</h2>
        <p className={styles.subtitle}>
          Start your secure chat experience today.
        </p>
